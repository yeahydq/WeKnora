export default {
  ...
  agentEditor: {
    ...
    im: {
      title: "IM 集成",
      description: "将智能体接入即时通讯平台，支持企业微信、飞书、Slack、Telegram、钉钉、Mattermost、Matrix和微信",
      wecom: "企业微信",
      feishu: "飞书",
      slack: "Slack",
      telegram: "Telegram",
      ...
      matrixConsole: "Matrix 接入文档",
      matrixModeHint: "Matrix 当前仅支持长轮询接入，请选择 WebSocket 模式（内部实际使用 /sync 轮询）",
      matrixUserIdHint: "可选。填写后可更稳定地过滤 Bot 自己发送的消息；留空时系统会启动时自动通过 whoami 获取。",
