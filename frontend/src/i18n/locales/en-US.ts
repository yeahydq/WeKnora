...
\
  ...
  agentEditor: {
    ...
    im: {
      ...
      description: 'Connect agent to instant messaging platforms like WeCom, Feishu, Slack, Telegram, DingTalk, Mattermost, Matrix and WeChat',
      feishu: 'Feishu',
      slack: 'Slack',
      telegram: 'Telegram',
      dingtalk: 'DingTalk',
      ...
      matrixConsole: 'Matrix integration docs',
      matrixModeHint: 'Matrix currently supports long polling only. Choose WebSocket mode here; the backend uses /sync polling internally.',
      matrixUserIdHint: 'Optional. Providing the bot user ID makes self-message filtering more reliable; if omitted, WeKnora resolves it via whoami at startup.',
